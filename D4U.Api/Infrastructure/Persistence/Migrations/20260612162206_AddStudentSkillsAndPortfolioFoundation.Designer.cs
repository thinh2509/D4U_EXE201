...
namespace D4U.Api.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260612162206_AddStudentSkillsAndPortfolioFoundation")]
    partial class AddStudentSkillsAndPortfolioFoundation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("D4U.Api.Domain.Entities.FeaturePackage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("feature_packages", "public");
            ...
            modelBuilder.Entity("D4U.Api.Domain.Entities.FeaturePackagePurchase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("FeaturePackageId")
                        .HasColumnType("uuid")
                        .HasColumnName("feature_package_id");
                    ...
                    b.HasIndex("FeaturePackageId", "Status");

                    b.HasIndex("BuyerUserId", "Status", "CreatedAt");

                    b.ToTable("feature_package_purchases", "public");
                });
            ...
            modelBuilder.Entity("D4U.Api.Domain.Entities.Notification", b =>
                {
                    ...
                    b.HasIndex("RecipientUserId", "Type", "ReferenceType", "ReferenceId")
                        .IsUnique()
            ...
            modelBuilder.Entity("D4U.Api.Domain.Entities.Payment", b =>
                {
                    ...
                    b.Property<Guid?>("FeaturePackagePurchaseId")
                        .HasColumnType("uuid")
                        .HasColumnName("feature_package_purchase_id");
                    ...
                    b.HasIndex("FeaturePackagePurchaseId", "Status");
            ...
            modelBuilder.Entity("D4U.Api.Domain.Entities.StudentPortfolioItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("StudentProfileId", "IsFeatured");

                    b.HasIndex("StudentProfileId", "Status");

                    b.ToTable("student_portfolio_items", "public");
                });

            modelBuilder.Entity("D4U.Api.Domain.Entities.StudentPortfolioItemSkill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("PortfolioItemId", "StudentSkillId")
                        .IsUnique();

                    b.ToTable("student_portfolio_item_skills", "public");
                });
            ...
            modelBuilder.Entity("D4U.Api.Domain.Entities.StudentSkill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("NormalizedSkillName")
                        ...
                        .HasColumnName("normalized_skill_name");
                    ...
                    b.HasIndex("StudentProfileId", "IsHighlighted");

                    b.HasIndex("StudentProfileId", "NormalizedSkillName")
                        .IsUnique();

                    b.ToTable("student_skills", "public");
                });
            ...
            modelBuilder.Entity("D4U.Api.Domain.Entities.UserFeatureEntitlement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("UsageConsumed")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("usage_consumed");
                    ...
                    b.HasIndex("FeaturePackagePurchaseId")
                        .IsUnique();

                    b.HasIndex("UserId", "EntitlementCode", "Status");

                    b.ToTable("user_feature_entitlements", "public");
                });
            ...
            modelBuilder.Entity("D4U.Api.Domain.Entities.FeaturePackagePurchase", b =>
                {
                    ...
                    b.HasOne("D4U.Api.Domain.Entities.FeaturePackage", null)
                        .WithMany()
            ...
            modelBuilder.Entity("D4U.Api.Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("D4U.Api.Domain.Entities.FeaturePackagePurchase", null)
                        .WithMany()
                        .HasForeignKey("FeaturePackagePurchaseId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("D4U.Api.Domain.Entities.StudentPortfolioItemSkill", b =>
                {
                    b.HasOne("D4U.Api.Domain.Entities.StudentPortfolioItem", null)
                        .WithMany()
                        .HasForeignKey("PortfolioItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("D4U.Api.Domain.Entities.StudentSkill", null)
                        .WithMany()
