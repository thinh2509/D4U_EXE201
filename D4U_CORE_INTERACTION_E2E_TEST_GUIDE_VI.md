...
| Giá đề xuất | `10000` |
| Số ngày dự kiến | `3` |
| Thư ứng tuyển | `Tôi có thể thực hiện bộ nhận diện theo brief và bàn giao đúng deadline.` |
...
Kết quả cần thấy: SME đọc được Student, giá đề xuất, số ngày dự kiến và thư ứng tuyển.

#### Chặng 2: SME Gửi Offer, Student Accept

**Bước 7 - SME tạo offer**

1. Trong danh sách ứng tuyển, bấm `Tạo offer` tại application của Student.
2. Nhập:

| Trường UI | Giá trị mẫu |
| --- | --- |
| Số tiền offer | `10000` |
| Hạn phản hồi | Một thời điểm trong tương lai |

3. Bấm `Tạo offer`.

Kết quả cần thấy:

- UI báo tạo offer thành công.
